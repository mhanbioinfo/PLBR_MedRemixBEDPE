...
rule trim_fastq:
    ...
    output:
        ...
        report_1 = path_to_data + '/{cohort}/qc/trim_galore/{sample}_lib{lib}_extract_barcode_R1.fastq_trimming_report.txt',
        report_2 = path_to_data + '/{cohort}/qc/trim_galore/{sample}_lib{lib}_extract_barcode_R2.fastq_trimming_report.txt'
    params:
